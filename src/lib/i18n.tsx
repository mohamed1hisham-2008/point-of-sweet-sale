...
const dict = {
  ar: {
    ...
    receiptSettingsDesc: "البيانات دي هتظهر في رأس وذيل الفاتورة المطبوعة.",
    phone: "رقم التليفون",
    address: "العنوان",
    taxNumber: "الرقم الضريبي",
    footerMessage: "رسالة أسفل الفاتورة",
    save: "حفظ",
    saved: "تم الحفظ ✅",
    print: "طباعة",
    close: "إغلاق",
    receiptTitle: "فاتورة",
    thanksDefault: "شكرًا لتسوقكم من Sweet Spot 🍬",
    cashier: "الكاشير",
  },
  en: {
    storeName: "Sweet Spot",
    ...
    receiptSettingsDesc: "This info appears on the printed receipt header and footer.",
    phone: "Phone number",
    address: "Address",
    ...
    thanksDefault: "Thank you for shopping at Sweet Spot 🍬",
    cashier: "Cashier",
  },
} as const;
